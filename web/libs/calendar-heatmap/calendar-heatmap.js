...
var calendarHeatmap = {
   ...
   * Initialize
   */
  init: function(color, overview, handler) {
  ...
  createElements: function() {
    ...
    var container = document.getElementsByClassName('calendar-heatmap')[0];
  ...
  drawGlobalOverview: function() {
    ...
    var item_block = calendarHeatmap.items.selectAll('.item-block-year')
      ...
      .on('mouseover', function(d) {
        ...
        // Construct tooltip
        var tooltip_html = '';
        tooltip_html += '<div><span><strong>Tag</strong></span>';
        tooltip_html += calendarHeatmap.selectedTag;
    ...
    calendarHeatmap.items.selectAll('.item-circle')
      ...
      */
      .on('mouseover', function(d) {
        ...
        tooltip_html += '<div><strong>' + moment(d.date).format('dddd, MMM Do YYYY') + '</strong></div><br>';
  ...
  drawMonthOverview: function() {
    ...
    item_block.selectAll('.item-block-rect')
      ...
      .on('mouseover', function(d) {
        ...
        var tooltip_html = '';
        /*
        tooltip_html += '<div><strong>' + d.value + ' ' + d.name + '</strong></div><br>';
        ...
        */
        tooltip_html += '<div><strong>' + moment(date).format('dddd, MMM Do YYYY') + '</strong></div><br>';
