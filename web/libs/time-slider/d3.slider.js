...
return function module() {
  ...
  // Private variables
  var axisScale,
      dispatch = d3.dispatch("slide", "end"),
  ...
  function slider(selection) {
    selection.each(function() {
      ...
      drag.on('end', function () {
        dispatch.call("end", null, d3.event, value);
      })
      ...
      function createAxis(dom) {
        ...
        if (typeof axis === "boolean") {
          ...
          axis.ticks(Math.round(sliderLength / 100))
        ...
        if (orientation === "horizontal") {
          ...
          svg.attr("width", margin);
          svg.attr("height", sliderLength + margin * 2);
  ...
  function moveHandle(newValue) {
    ...
    if (oldPos !== newPos) {
      ...
      if (toType(value) == "array" && value.length == 2) {
        ...
        if (d3.event) {
          dispatch.call("slide", null, d3.event, value );
        };
      } else {
        if (d3.event) {
          dispatch.call("slide", null, d3.event.sourceEvent || d3.event, value = newValue);
        };
      }
